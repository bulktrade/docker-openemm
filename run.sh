...
if [ -f /home/openemm/.NOT_CONFIGURED ]; then
	...
	sed -i "s/system.mail.host=localhost/system.mail.host=$MAIL_PORT_25_TCP_ADDR'/g" /home/openemm/webapps/openemm/WEB-INF/classes/emm.properties
	...
	echo "${MAIL_ENV_smtp_user}@${MAIL_PORT_25_TCP_ADDR}" > /home/openemm/conf/smart-relay
